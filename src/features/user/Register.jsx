...
import { fetchRegister, setError } from "../../slices/userSlice";
...
function Register() {
  ...
  return (
    <div className="px-8 py-2" data-testid="register-component">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-10 rounded-xs bg-purple-600 py-1.5 hover:cursor-pointer hover:bg-purple-800 disabled:cursor-default disabled:bg-purple-800"
        >
          {status === "loading" ? <Spinner size="mini" /> : "Register"}
        </button>
      </form>
    </div>
  );
